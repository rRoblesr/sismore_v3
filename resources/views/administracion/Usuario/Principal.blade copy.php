                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="input-group">
                                                            <select name="entidadgerencia" id="entidadgerencia"
                                                                class="form-control" onchange="cargar_oficina(0)">
                                                                <option value="">SELECCIONAR</option>
                                                            </select>
                                                            <span class="help-block"></span>
                                                            <span class="input-group-append">
...
@section('js')
    ...
    <script>
        ...
        function edit(id) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    //if (data.entidad) {
                    var de1 = data.entidad ? data.entidad.entidad : 0;
                    var de2 = data.entidad ? data.entidad.gerencia : 0;
                    var de3 = data.entidad ? data.entidad.oficina : 0;
                    /* begin entidad */
                    $.ajax({
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.status) {
                        ...
                        if (form_entidad == 0)
                            cargar_entidad(data.entidad);
                        else if (form_entidad == 1)
                            cargar_gerencia(data.entidad);
                        else if (form_entidad == 2)
                            cargar_oficina(data.entidad);
                        toastr.success("El registro fue creado exitosamente.", 'Mensaje');
                    } else {
                        for (var i = 0; i < data.inputerror.length; i++) {
                            $('[name="' + data.inputerror[i] + '"]').parent().addClass('has-error');
        ...
        function add_gerencia() {
            ...
            $('#modal_form_entidad .modal-title').text('Nueva Gerencia');
            $('#modal_form_entidad').modal('show');
            form_entidad = 1;
        }
