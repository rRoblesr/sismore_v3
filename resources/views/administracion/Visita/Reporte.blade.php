    ...
    <div class="content">
        ...
        <div class="row">
                ...
                <div class="card-box border border-plomo-0">
                    <div class="media">
                        <div class="avatar-md mr-2">
                            <i class="mdi mdi-eye avatar-title font-30 text-success"></i>
                        </div>
                        <div class="media-body align-self-center">
                            <div class="text-right">
                                ...
                                <p class="mb-0 mt-1 text-truncate">Total Visitas</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6 col-xl-3">
                <div class="card-box border border-plomo-0">
                    <div class="media">
                        <div class="avatar-md mr-2">
                            <i class="mdi mdi-account-network avatar-title font-30 text-primary"></i>
                        </div>
                        <div class="media-body align-self-center">
                            <div class="text-right">
                                ...
                                <p class="mb-0 mt-1 text-truncate">IPs Únicas</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="media">
                        ...
                        <div class="media-body align-self-center">
                            <div class="text-right">
                                ...
                                <p class="mb-0 mt-1 text-truncate">Visitas Hoy</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6 col-xl-3">
                <div class="card-box border border-plomo-0">
                    <div class="media">
                        <div class="avatar-md mr-2">
                            <i class="mdi mdi-server-network avatar-title font-30 text-info"></i>
                        </div>
                        <div class="media-body align-self-center">
                            <div class="text-right">
                                ...
                                <p class="mb-0 mt-1 text-truncate">Top Sistema</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-xl-8">
                <div class="card card-border">
                    <div class="card-header border-success-0 bg-transparent pb-0">
                        <h3 class="card-title text-primary">Tendencia de Visitas</h3>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-xl-4">
                <div class="card card-border">
                    <div class="card-header border-success-0 bg-transparent pb-0">
                        <h3 class="card-title text-primary">Visitas por Sistema</h3>
                    </div>
                    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-border">
                    <div class="card-header border-success-0 bg-transparent pb-0">
                        <h3 class="card-title text-primary">Tendencia por Sistema</h3>
                    </div>
                    <div class="card-body">
    ...
    <script>
        $(document).ready(function() {
            function cargarResumen() {
                $.ajax({
                    url: "{{ route('visitas.reporte.resumen') }}",
                    type: "GET",
                    dataType: "json",
                    data: {
                        sistema: $('#sistema').val(),
                    ...
                    success: function(data) {
                        ...
                        Highcharts.chart('grafico1', {
                            ...
                            yAxis: { min: 0, title: { text: 'Visitas' } },
                            tooltip: {
