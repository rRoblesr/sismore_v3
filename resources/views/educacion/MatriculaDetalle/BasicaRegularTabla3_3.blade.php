<table id="tablaEBR3_3" class="table table-striped table-bordered tablex" style="font-size:11px;">
    <thead>
        <tr class="bg-primary text-white text-center">
            <td rowspan="4"></td>
            <td rowspan="4">CENTRO POBLADO</td>
    ...
    <tbody>
        @foreach ($base as $key => $item2)
            <tr class="text-center">
                <th>{{ $key+1 }}</th>
                <td class="text-left">
                    <a href="#" onclick="">{{ $item2->centro_poblado }}</a>
                </td>
