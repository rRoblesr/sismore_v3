        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="" id="form_datosindicador" name="form" class="form-horizontal" autocomplete="off">
                        @csrf
...
@section('js')
    <script type="text/javascript">
        ...
        function GaugeSeries(div, data) {
            // Asegurarse de que el valor de data esté dentro del rango [0, 100]
            // data = Math.min(Math.max(data, 0), 100);

            // Configuración de colores para las clases de datos
            const dataClasses = [{
                    from: 0,
                    to: 50,
                    color: '#ef5350'
        ...
        function GaugeSeriesyy(div, data) {
            // Configuración de colores para las clases de datos
            const dataClasses = [{
                    from: 0,
                    to: 50,
        ...
        function GaugeSerieszzz(div, data) {
