        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="card card-border border border-plomo-0">
                    ...
                    <div class="card-body p-0" style="height: 45.5rem">
                        {{-- <figure class="highcharts-figure p-0 m-0"> --}}
                            <div id="anal3" style="height:100%"></div>
                        {{-- </figure> --}}
            ...
            <div class="col-lg-6">
                <div class="card card-border border border-plomo-0 vtabla1">
                    <div class="card-header border-success-0 bg-transparent pt-2 pl-1 pr-1 pb-0">
                        <h3 class="text-black font-12 m-0">Locales Educativos conectados a red de agua potable, según
                            Distritos
                        </h3>
                    </div>
                    <div class="card-body p-0" style="height: 44.1rem">
                        {{-- <div class="row"> --}}
                            {{-- <div class="col-12"> --}}
                                <div class="table-responsive" id="vtabla1"></div>
                            {{-- </div> --}}
                        {{-- </div> --}}
            ...
            <div class="col-lg-12">
                <div class="card card-border border border-plomo-0 vtabla2">
                    <div class="card-header border-success-0 bg-transparent pb-0 pt-2">
                        ...
                        <h3 class="text-black font-12">Locales Educativos conectados, según Provincia</h3>
                    </div>
            ...
            <div class="col-lg-12">
                <div class="card card-border border border-plomo-0">
                    <div class="card-header border-success-0 bg-transparent  pt-2 pl-1 pr-1 pb-0">
                        ...
                        <h3 class="text-black font-12">Locales Educativos conectados</h3>
                    </div>
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col-lg-12">
