<table id="tabla2" class="table table-striped table-bordered tablex" style="font-size:9px;">
    <thead>
        <tr class="bg-success-0 text-white text-center">
            ...
            <th rowspan="1" colspan="5">Estudiantes por Grado</th>
        </tr>
        <tr class="bg-success-0 text-white text-center">
            ...
            <th class="text-center">Inicial Primero</th>
            <th class="text-center">Inicial Segundo</th>
            <th class="text-center">Intermedio Primero</th>
            <th class="text-center">Intermedio Segundo</th>
            <th class="text-center">Intermedio Tercero</th>
        </tr>
    </thead>
    @if ($base->count() > 0)
        <tbody>
