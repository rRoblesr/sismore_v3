            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-header bg-success-0">
                        ...
                        <h3 class="card-title text-white">Niveles Educativos de la educación básica especial</h3>
                    </div>
...
@section('js')
    <script type="text/javascript">
        ...
        function panelGraficas(div) {
            $.ajax({
                url: "{{ route('matriculageneral.niveleducativo.ebe.tablas') }}",
                data: {
                    'div': div,
                    "anio": $('#anio').val(),
        ...
        function descargar1() {
            window.open("{{ url('/') }}/MatriculaGeneral/NivelEBE/Excel/tabla1/" + $('#anio').val() + "/" +
                $('#provincia').val() + "/" + $('#distrito').val() + "/" + $('#nivel').val());
        }

        function descargar2() {
            window.open("{{ url('/') }}/MatriculaGeneral/NivelEBE/Excel/tabla2/" + $('#anio').val() + "/" +
                $('#provincia').val() + "/" + $('#distrito').val() + "/" + $('#nivel').val());
        }
