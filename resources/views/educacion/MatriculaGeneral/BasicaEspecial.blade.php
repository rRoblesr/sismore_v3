                ...
                <div class="card">
                    <div class="card-header bg-success-0">
                        <div class="card-widgets">
                            <button type="button" class="btn btn-orange-0 btn-xs"
                                onclick="location.href=`{{ route('matriculageneral.niveleducativo.ebe.principal') }}`"
                        ...
                        <h3 class="card-title text-white">Educación Básica Especial</h3>
                    </div>
                    <div class="card-body pb-0">
                        <div class="form-group row align-items-center vh-5">
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-2">
                                <select id="dependencia" name="dependencia" class="form-control btn-xs font-11"
                                    onchange="cargarCards();">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body align-self-center">
                            <div class="text-right">
                                ...
                                <p class="mb-0 mt-1 text-truncate">Matriculados Prite </p>
                            </div>
                        </div>
                    </div>
                    <div class="mt-0 font-9">
...
@section('js')
    <script type="text/javascript">
        ...
        function panelGraficas(div) {
            $.ajax({
                url: "{{ route('matriculageneral.ebe.tablas') }}",
                data: {
                    'div': div,
                    "anio": $('#anio').val(),
                    "ugel": $('#ugel').val(),
                ...
                success: function(data) {
                    if (div == 'head') {
                        ...
                        gPie2(div, data.info, '',
                            'Número de estudiantes matriculados en educación básica especial, según sexo',
                            '');
                        ...
                        gbar(div, data.info.categoria, data.info.series, '',
                            'Número de estudiantes extranjeros matriculados en educación básica por sexo especial, según país de nacimiento',
                            '');
                        $('.anal7-fuente').html('Fuente: ' + data.reg.fuente);
                        $('.anal7-fecha').html('Actualizado: ' + data.reg.fecha);
                    } else if (div == "anal8") {
                        gbar(div, data.info.categoria, data.info.series, '',
                            'Número de estudiantes con discapacidad matriculados en educación básica especial por sexo, según tipo de discapacidad',
                            '');
