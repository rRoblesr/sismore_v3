            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-header bg-success-0">
                        ...
                        <h3 class="card-title text-white">Niveles Educativos de la educación básica regular</h3>
                    </div>
                    ...
                    <div class="media">
                        ...
                        <div class="media-body align-self-center">
                            <div class="text-right">
                                ...
                                <p class="mb-0 mt-1 text-truncate">Estudiantes EIB</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header bg-success-0 py-3 text-white">
                        ...
                        <h5 class="card-title mb-0 text-white">EBR - Nivel Inicial</h5>
                    </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header bg-success-0 py-3 text-white">
                        ...
                        <h5 class="card-title mb-0 text-white">EBR - Nivel Primaria</h5>
                    </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="card card-border border border-plomo-0">
                                        ...
                                        <div class="card-body pt-0 pb-0">
                                            ...
                                            {{-- <div class="font-weight-bold text-muted ml-2 mr-2 font-9 p-0">
                                                <span class="float-left vtabla3-fuente">Fuente: </span>
                                                <span class="float-right vtabla3-fecha">Actualizado:</span>
                                            </div> --}}
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header bg-success-0 py-3 text-white">
                        <div class="card-widgets">
                            {{-- <a href="javascript:;" data-toggle="reload"><i class="mdi mdi-refresh"></i></a> --}}
                            <a data-toggle="collapse" href="#portles3" role="button" aria-expanded="false"
                                aria-controls="portles3"><i class="mdi mdi-minus"></i></a>
                            {{-- <a href="#" data-toggle="remove"><i class="mdi mdi-close"></i></a> --}}
                        </div>
                        <h5 class="card-title mb-0 text-white">EBR - Nivel Secundaria</h5>
                    </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="card card-border border border-plomo-0">
                                        <div class="card-header border-success-0 bg-transparent pb-0 pt-2">
                                            <div class="card-widgets">
                                                <button type="button" class="btn btn-success btn-xs"
                                                    onclick="descargar4()"><i class="fa fa-file-excel"></i>
                                                    Descargar</button>
                                            </div>
                                            <h3 class="text-black font-14">Matricula educativa de estudiantes de nivel
                                                secundaria, por edades, según institución educativa</h3>
                                        </div>
                                        <div class="card-body pt-0 pb-0">
                                            <div class="row">
                                                <div class="col-12">
                                            ...
                                            {{--  <div class="font-weight-bold text-muted ml-2 mr-2 font-9 p-0">
                                                <span class="float-left vtabla4-fuente">Fuente: </span>
                                                <span class="float-right vtabla4-fecha">Actualizado:</span>
                                            </div> --}}
                                        </div>
                                    </div>
                                </div>
...
@section('js')
    <script type="text/javascript">
        ...
        function panelGraficas(div) {
            $.ajax({
                url: "{{ route('matriculageneral.niveleducativo.tablas') }}",
                data: {
                    'div': div,
                    "anio": $('#anio').val(),
                ...
                success: function(data) {
                    if (div == 'head') {
                        ...
                        gcolumn2(div,
                            ...
                            data.info.series,
                            '',
                            'Número de estudiantes  matriculados por modelo de estudios, según UGEL'
                        );
                        $('.anal1-fuente').html('Fuente: ' + data.reg.fuente);
                        $('.anal1-fecha').html('Actualizado: ' + data.reg.fecha);
                    } else if (div == "anal2") {
                        gPie(div, data.info, '', 'Número de estudiantes matriculados, según Ámbito Geográfico',
                            '');
                        ...
                        gbar(div, data.info.categoria, data.info.series, '',
                            'Número de estudiantes extranjeros matriculados, por sexo, según país de nacimiento',
                            '');
                        $('.anal5-fuente').html('Fuente: ' + data.reg.fuente);
                        $('.anal5-fecha').html('Actualizado: ' + data.reg.fecha);
                    } else if (div == "anal6") {
                        gbar(div, data.info.categoria, data.info.series, '',
                            'Número de estudiantes discapacitados matriculados, por sexo, según tipo de discapacidad',
                            '');
                        ...
                        $('.vtabla4-fuente').html('Fuente: ' + data.reg.fuente);
                        $('.vtabla4-fecha').html('Actualizado: ' + data.reg.fecha);
                        if (data.nbase > 0) {
                            $('#tabla4').DataTable({
                                responsive: true,
                                autoWidth: false,
        ...
        function descargar1() {
            window.open("{{ url('/') }}/MatriculaGeneral/NivelEBR/Excel/tabla1/" + $('#anio').val() + "/" +
                $('#provincia').val() + "/" + $('#distrito').val() + "/" + $('#nivel').val());
        }

        function descargar2() {
            window.open("{{ url('/') }}/MatriculaGeneral/NivelEBR/Excel/tabla2/" + $('#anio').val() + "/" +
                $('#provincia').val() + "/" + $('#distrito').val() + "/" + $('#nivel').val());
        }

        function descargar3() {
            window.open("{{ url('/') }}/MatriculaGeneral/NivelEBR/Excel/tabla3/" + $('#anio').val() + "/" +
                $('#provincia').val() + "/" + $('#distrito').val() + "/" + $('#nivel').val());
        }

        function descargar4() {
            window.open("{{ url('/') }}/MatriculaGeneral/NivelEBR/Excel/tabla4/" + $('#anio').val() + "/" +
                $('#provincia').val() + "/" + $('#distrito').val() + "/" + $('#nivel').val());
        }
