<table id="tabla2" class="table table-striped table-bordered tablex" style="font-size:9px;">
    <thead>
        <tr>
            ...
            <td rowspan="2" style="background-color:#317eeb;color:#ffffff;text-align:center;">Institución Educativa
            </td>
            ...
            <th rowspan="1" colspan="3" style="background-color:#317eeb;color:#ffffff;text-align:center;">
                Estudiantes</th>
            <th rowspan="2" style="background-color:#317eeb;color:#ffffff;text-align:center;">%Avance</th>
            <th rowspan="1" colspan="7" style="background-color:#317eeb;color:#ffffff;text-align:center;">
                Estudiantes por Edad</th>
        </tr>
        <tr>
            ...
            <th style="background-color:#317eeb;color:#ffffff;text-align:center;">0 años</th>
            <th style="background-color:#317eeb;color:#ffffff;text-align:center;">1 año</th>
            <th style="background-color:#317eeb;color:#ffffff;text-align:center;">2 años</th>
            <th style="background-color:#317eeb;color:#ffffff;text-align:center;">3 años</th>
            <th style="background-color:#317eeb;color:#ffffff;text-align:center;">4 años</th>
            <th style="background-color:#317eeb;color:#ffffff;text-align:center;">5 años</th>
            <th style="background-color:#317eeb;color:#ffffff;text-align:center;">más de 5 años</th>
        </tr>
    </thead>
    @if ($base->count() > 0)
        <tbody>
            @foreach ($base as $key => $item)
                <tr>
                    ...
                    <td style="text-align:right;">{{ number_format($item->e0, 0) }}</td>
                    ...
                    <td style="text-align:right;">{{ number_format($item->e6, 0) }}</td>
                </tr>
            @endforeach
        </tbody>
        <tfoot>
            <tr>
                ...
                <th style="background-color:#317eeb;color:#ffffff;text-align:right;">
                    {{ number_format($foot->meta, 0) }}</th>
                <th style="background-color:#317eeb;color:#ffffff;text-align:right;">{{ number_format($foot->th, 0) }}
                </th>
                <th style="background-color:#317eeb;color:#ffffff;text-align:right;">{{ number_format($foot->tm, 0) }}
                </th>
                <th style="background-color:#317eeb;color:#ffffff;text-align:right;">{{ number_format($foot->tt, 0) }}
                </th>
                <th style="background-color:#317eeb;color:#ffffff;text-align:right;">{!! avance($foot->avance, 1) !!}</th>
                <th style="background-color:#317eeb;color:#ffffff;text-align:right;">{{ number_format($foot->e0, 0) }}
                </th>
                <th style="background-color:#317eeb;color:#ffffff;text-align:right;">{{ number_format($foot->e1, 0) }}
                </th>
                <th style="background-color:#317eeb;color:#ffffff;text-align:right;">{{ number_format($foot->e2, 0) }}
                </th>
                <th style="background-color:#317eeb;color:#ffffff;text-align:right;">{{ number_format($foot->e3, 0) }}
                </th>
                <th style="background-color:#317eeb;color:#ffffff;text-align:right;">{{ number_format($foot->e4, 0) }}
                </th>
                <th style="background-color:#317eeb;color:#ffffff;text-align:right;">{{ number_format($foot->e5, 0) }}
                </th>
                <th style="background-color:#317eeb;color:#ffffff;text-align:right;">{{ number_format($foot->e6, 0) }}
                </th>
            </tr>
        </tfoot>
    @else
        <tbody>
            <tr>
                <td colspan="24"><a href="#" class="">Sin información</a></td>
            </tr>
        </tbody>
    @endif
</table>
