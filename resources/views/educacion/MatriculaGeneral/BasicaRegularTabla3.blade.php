<table id="tabla3" class="table table-striped table-bordered tablex" style="font-size:11px;">
    <thead>
        <tr class="bg-success-0 text-white text-center">
            ...
            <th colspan="6" class="text-center">INICIAL</th>
            <th colspan="9" class="text-center">PRIMARIA</th>
            <th colspan="6" class="text-center">SECUNDARIA</th>
        </tr>
        <tr class="bg-success-0 text-white text-center">
