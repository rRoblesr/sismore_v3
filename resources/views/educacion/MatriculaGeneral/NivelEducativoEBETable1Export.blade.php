<table id="tabla2" class="table table-striped table-bordered tablex" style="font-size:9px;">
    <thead>
        <tr>
            ...
            <th rowspan="1" colspan="7" style="background-color:#317eeb;color:#ffffff;text-align:center;">Estudiantes por Edad</th>
        </tr>
        <tr>
    ...
    @if ($base->count() > 0)
        ...
        <tfoot>
            <tr>
                ...
                <th style="background-color:#317eeb;color:#ffffff;text-align:right;">{{ number_format($foot->e0, 0) }}</th>
                ...
                <th style="background-color:#317eeb;color:#ffffff;text-align:right;">{{ number_format($foot->e6, 0) }}</th>
            </tr>
        </tfoot>
    @else
        <tbody>
