<table id="tabla3" class="table table-striped table-bordered tablex" style="font-size:9px;">
    <thead>
        <tr>
            ...
            <th rowspan="1" colspan="6" style="background-color:#317eeb;color:#ffffff;text-align:center;">Estudiantes por Grado</th>
        </tr>
        <tr>
            ...
            <th style="background-color:#317eeb;color:#ffffff;text-align:center;">Sexto</th>
        </tr>
    </thead>
    @if ($base->count() > 0)
        <tbody>
