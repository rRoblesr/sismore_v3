<table id="tabla1" class="table table-striped table-bordered tablex" style="font-size:11px;">
    <thead>
        <tr class="bg-success-0 text-white text-center">
            ...
            <td rowspan="2">%</td>
            <th rowspan="1" colspan="3">Publico</th>
            <th rowspan="1" colspan="3">Privado</th>
            <th rowspan="1" colspan="3">Urbano</th>
            <th rowspan="1" colspan="3">Rural</th>
        </tr>
        <tr class="bg-success-0 text-white text-center">
    ...
    @if ($base->count() > 0)
        ...
        <tfoot>
            <tr class="text-center bg-success-0 text-white">
                ...
                <th class="text-center">{{ number_format($foot->avance, 1) }}%</th>
