<table id="tabla1" class="table table-striped table-bordered tablex" style="font-size:11px;">
    <thead>
        <tr>
            ...
            <th colspan="2" style="background-color:#317eeb;color:#ffffff;text-align:center;">Intermedio</th>
            <th colspan="2" style="background-color:#317eeb;color:#ffffff;text-align:center;">Avanzado</th>
