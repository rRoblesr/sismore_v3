    ...
    <table id="tabla1" class="table table-striped table-bordered tablex" style="font-size:10px;">
        <thead>
            <tr class="table-success-0 text-white">
                ...
                <th rowspan="1" style="background-color:#317eeb;color:#ffffff;text-align:center;">FECHA INSCRIPCION
                </th>
            ...
            @foreach ($base as $key => $item)
                <tr class="text-right">
                    ...
                    <td style="text-align:left;">
                        {{ $item->estados == 1 ? 'SANEADO' : ($item->estados == 2 ? 'NO SANEADO' : ($item->estados == 3 ? 'NO REGISTRADO' : 'EN PROCESO')) }}
                    </td>
                </tr>
            @endforeach
        </tbody>
    ...
    <table id="tabla1" class="table table-striped table-bordered tablex" style="font-size:10px;">
        <thead>
            <tr class="table-success-0 text-white">
                ...
                <th rowspan="1" style="background-color:#317eeb;color:#ffffff;text-align:center;">INSTITUCIONES
                    EDUCATIVAS</th>
                <th rowspan="1" style="background-color:#317eeb;color:#ffffff;text-align:center;">NIVEL Y MODALIDAD
                </th>
                <th rowspan="1" style="background-color:#317eeb;color:#ffffff;text-align:center;">AREA</th>
                ...
                <th rowspan="1" style="background-color:#317eeb;color:#ffffff;text-align:center;">FECHA INSCRIPCIÓN
                </th>
                <th rowspan="1" style="background-color:#317eeb;color:#ffffff;text-align:center;">ESTADO DEL SFL</th>
            </tr>
        </thead>
        <tbody>
            @foreach ($base as $key => $item)
                <tr class="text-right">
                    ...
                    <td style="text-align:left;">{{ $item->distrito }}</td>
                    <td style="text-align:left;">{{ $item->ugel }}</td>
                    <td style="text-align:left;">{{ $item->fecha_registro }}</td>
