@extends('layouts.main',['titlePage'=>'IMPORTAR DATOS - CENSO EDUCATIVO'])
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form">
                        ...
                        <form action="{{route('Censo.guardar')}}" method="post" enctype='multipart/form-data'
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" readonly="readonly" value="CENSO EDUCATIVO">
                                </div>
                            </div>

                            <div class="form-group row">
                                <label class="col-md-2 col-form-label">Año Censo</label>
