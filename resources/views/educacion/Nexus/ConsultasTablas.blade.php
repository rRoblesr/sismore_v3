@switch($div)
    @case('tabla1')
        <table id="tabla1" class="table table-striped table-bordered font-12 m-0 ">
            <thead>
                <tr class="table-success-0 text-white">
                    <th class="text-center">AÑO</th>
                    <th class="text-center">Código Plaza</th>
                    ...
                    {{-- <th class="text-center">Tipo Institución</th> --}}
            ...
            <tbody>
                @foreach ($base as $key => $item)
                    <tr class="text-center">
                        ...
                        {{-- <td>{{ $item->zona }}</td> --}}
                        <td>{{ $item->nivel }}</td>
                        <td><a href="#" onclick="openiiee({{ $item->ie_id }})"> {{ $item->modular }} </a></td>
