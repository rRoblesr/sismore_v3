                ...
                <div class="col-lg-12 col-md-12">
                    <div class="card">
                        <div class="card-header bg-success-0">
                            ...
                            <h3 class="card-title text-white font-14">EDUCACIÓN SUPERIOR TECNOLÓGICO</h3>
                        </div>
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        function cargarCards() {
            ...
            $.ajax({
                url: "{{ route('superiortecnologico.principal.head') }}",
                data: {
                    "anio": $('#anio').val(),
                    "provincia": 0,
                    "distrito": 0,
        ...
        function cargarUgels() {
            $.ajax({
                url: "{{ route('superiortecnologico.ugel') }}",
                type: 'GET',
                success: function(data) {
                    $("#ugel option").remove();
        ...
        function cargarAreas() {
            $.ajax({
                url: "{{ route('superiortecnologico.area') }}",
                data: {
                    gestion: $('#gestion').val(),
                },
                type: 'GET',
                ...
                success: function(data) {
                    if (div == "anal1") {
                        gAnidadaColumn(div,
                            ...
                            data.info.series,
                            '',
                            'Porcentaje de estudiantes matriculados en educación Superior Tecnológico',
                            data.info.maxbar
                        );
                    ...
                    if (div == "anal2") {
                        gcolumn2(div,
                            ...
                            data.info.series,
                            '',
                            'Número de postulantes e ingresantes en educación Superior Tecnológico'
                        );
                    ...
                    if (div == "anal3") {
                        gcolumn('anal3',
                            ...
                            data.series,
                            '',
                            'Número de estudiantes matriculados en educación Superior Tecnológico de Rango de Edades, según sexo',
                        );
                    ...
                    if (div == "anal4") {
                        gbar('anal4',
                            ...
                            data.series,
                            '',
                            'Número de estudiantes matriculados en educación Superior Tecnológico de lengua materna, según sexo',
                        );
        ...
        function descargar() {
            window.open("{{ url('/') }}/SuperiorTecnologico/Exportar/Excel/" + $('#anio').val() +
