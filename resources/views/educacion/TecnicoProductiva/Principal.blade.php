...
@section('js')
    <script type="text/javascript">
        ...
        function panelGraficas(div) {
            $.ajax({
                url: "{{ route('tecnicoproductiva.principal.tabla') }}",
                data: {
                    'div': div,
                    "anio": $('#anio').val(),
                    "provincia": 0,
                ...
                success: function(data) {
                    if (div == "anal1") {
                        gAnidadaColumn(div,
                            ...
                            data.info.series,
                            '',
                            'Número de estudiantes matriculados en educación Técnica Productiva',
                            data.info.maxbar
                        );
                    ...
                    if (div == "anal2") {
                        gcolumn2(div,
                            ...
                            data.info.series,
                            '',
                            'Número de estudiantes matriculados en educación Técnica Productiva, según Nivel Profesional'
                        );
                    ...
                    if (div == "anal3") {
                        gcolumn('anal3',
                            ...
                            data.series,
                            '',
                            'Número de estudiantes matriculados en educación Técnica Productiva de Rango de Edades, según sexo',
                        );
                    ...
                    if (div == "anal4") {
                        gbar('anal4',
                            ...
                            data.series,
                            '',
                            'Número de estudiantes matriculados en educación Técnica Productiva de lengua materna, según sexo',
                        );
        ...
        function cargarUgels() {
            $.ajax({
                url: "{{ route('tecnicoproductiva.ugel') }}",
                type: 'GET',
                success: function(data) {
                    $("#ugel option").remove();
