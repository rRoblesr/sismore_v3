...
@section('js')
    <script type="text/javascript">
        ...
        function cargarUgels() {
            $.ajax({
                url: "{{ route('superiorartistico.ugel') }}",
                type: 'GET',
                success: function(data) {
                    $("#ugel option").remove();
                ...
                success: function(data) {
                    if (div == "anal1") {
                        gAnidadaColumn(div,
                            ...
                            data.info.series,
                            '',
                            'Porcentaje de estudiantes matriculados en educación Superior Artístico',
                            data.info.maxbar
                        );
                    ...
                    if (div == "anal2") {
                        gcolumn2(div,
                            ...
                            data.info.series,
                            '',
                            'Número de postulantes e ingresantes en educación Superior Artístico'
                        );
                    ...
                    if (div == "anal3") {
                        gcolumn('anal3',
                            ...
                            data.series,
                            '',
                            'Número de estudiantes matriculados en educación Superior Artístico de Rango de Edades, según sexo',
                        );
                    ...
                    if (div == "anal4") {
                        gbar('anal4',
                            ...
                            data.series,
                            '',
                            'Número de estudiantes matriculados en educación Superior Artístico de lengua materna, según sexo',
                        );
        ...
        function descargar() {
            window.open("{{ url('/') }}/SuperiorArtistico/Exportar/Excel/" + $('#anio').val() +
