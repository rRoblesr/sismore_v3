    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table_principal = $('#datatable').DataTable({
                ...
                ajax: "{{ route('imporpadronpvica.listar.importados') }}",
                type: "POST",
            });
        });
        ...
        function upload(e) {
            ...
            $.ajax({
                ...
                type: "POST",
                url: "{{ route('imporpadronpvica.guardar') }}",
                dataType: "json",
                contentType: false,
                processData: false,
                cache: false,
        ...
        function geteliminar(id) {
            bootbox.confirm("¿Seguro desea eliminar esta importación?", function(result) {
                if (result === true) {
                    $.ajax({
                        url: "{{ route('imporpadronpvica.eliminar', '') }}/" + id,
                        type: "GET",
                        dataType: "JSON",
        ...
        function monitor(id) {
            $('#siagie-matricula').DataTable({
                    ...
                    "ajax": {
                        ...
                        "url": "{{ route('imporpadronpvica.listarimportados') }}",
                        "data": {
                            "importacion_id": id
                        },
                        "type": "POST",
