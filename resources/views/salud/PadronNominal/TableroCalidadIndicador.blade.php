                        ...
                        <div class="col-12">
                            <div class="table-responsive">
                                <table id="xx" class="table table-striped table-bordered font-12 text-dark">
                                    <tbody>
                                        <tr>
                                            <td class="text-left table-success-0 text-white" colspan="6">DATOS DEL
                                                MENOR
                                            </td>
                                        </tr>
                                        <tr>
    ...
    @section('js')
        <script type="text/javascript">
            ...
            function abrirmodalpadron(padron) {
                ...
                $.ajax({
                    url: "{{ route('salud.padronnominal.tablerocalidad.criterio.find1', ['importacion' => 0, 'padron' => 'padron']) }}"
            ...
            function consultahacer() {
                ...
                if (doc != '' || ape != '') {
                    $.ajax({
                        url: "{{ route('salud.padronnominal.tablerocalidad.consulta.find1', ['importacion' => $imp->id, 'tipo' => 'tipo', 'documento' => 'documento', 'apellido' => 'apellido']) }}"
                            .replace('tipo', tip)
                            .replace('documento', doc == '' ? 'documento' : doc)
                        ...
                        success: function(data) {
                            if (Object.keys(data).length > 0) {
                                ...
                                $('#formulario').hide();
                                toastr.error('REGISTRO NO ENCONTRADO', 'Mensaje');
                            }
