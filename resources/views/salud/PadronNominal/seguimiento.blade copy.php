            ...
            <div class="card">
                <div class="card-header bg-success-0">
                    <div class="card-widgets">
                        ...
                        {{-- <button type="button" class="btn btn-orange-0" onclick="location.reload()"
                ...
                <div class="card-body pb-0">
                    <div class="form-group row align-items-center vh-5">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2">
                            <label class="small m-0" for="microred">Red</label>
                            <select class="form-control form-control-sm" name="red" id="red"
                                onchange="cargarListadoRed();">
                                <option value="0">Todos</option>
                                {{-- @foreach ($grupo_red as $item)
                                    <option {{ $idd_grupo == $item->cod_red ? 'selected' : '' }}
                                        value="{{ $item->cod_red }}">
                                        {{ $item->nom_red }}</option>
                                @endforeach --}}
                            </select>
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2">
                            <label class="small m-0" for="microred">MicroRed</label>
                            <select class="form-control form-control-sm" name="microred" id="microred"
                                onchange="cargarListadoMicrored();">
                                <option value="0">Todos</option>
                                {{-- @foreach ($grupo_microred as $item)
                                    <option {{ $idd_grupo == $item->cod_mic ? 'selected' : '' }}
                                        value="{{ $item->cod_mic }}">
                                        {{ $item->nom_mic }}</option>
                                @endforeach --}}
                            </select>
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2">
                            <label class="small m-0" for="ipress">EE.SS</label>
                            <select class="form-control form-control-sm" name="ipress" id="ipress"
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2">
                            <label class="small m-0" for="grupoedad">GRUPO DE EDAD</label>
                            <select class="form-control form-control-sm" name="grupoedad" id="grupoedad"
                                onchange="cargarListadoGrupoEdad();">
                                <option value="0"> Todos</option>
                                <option value="1"> Recién Nacido</option>
                                <option value="2"> Menor de 12 meses</option>
                                <option value="3"> De 1 año</option>
                                <option value="4"> De 2 años</option>
                            </select>
                        </div>
        ...
        <div class="col-md-12">
            <div class="card card-border">
                ...
                <div class="card-header border-success-0 bg-transparent pb-0">
                    <div class="card-widgets">
                        <button type="button" class="btn btn-xs btn-danger" onclick="location.reload()">
                            <i class="fa fa-redo"></i> Actualizar</button>
                        <button type="button" class="btn btn-xs btn-success-0"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content p-0">
                <ul class="nav nav-tabs nav-justified" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="hemoglobina-tab-1" data-toggle="tab" href="#hemoglobina-1" role="tab"
                            aria-controls="hemoglobina-1" aria-selected="false">
                            <span class="d-block d-sm-none"><i class="fa fa-user"></i></span>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="fecha_nacimiento" class="form-control" placeholder="-"
                                            readonly>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table_principal = $('#datatableS').DataTable({
                ...
                ajax: "{{ route('salud.padron.seguimiento.listar', ['', $codigo_institucion]) }}",
                type: "POST",
                columnDefs: [{
