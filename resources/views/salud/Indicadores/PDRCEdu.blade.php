    ...
    <div class="content">
        ...
        <div class="form-group row align-items-center vh-5">
            <div class="col-lg-6 col-md-6 col-sm-6">
                <h4 class="page-title font-16">PLAN DE DESARROLLO REGIONAL CONCERTADO</h4>
            </div>
                    ...
                    <div class="card text-center border border-success-0">
                        ...
                        <div class="pb-4 pl-4 pr-4">
                            ...
                            <div class="mt-1 pt-1">
                                ...
                                <a href="{{ route('salud.indicador.pdrc.detalle', $item->id) }}"
...
@section('js')
    <script type="text/javascript">
        ...
        function cargarActualizar(codigo) {
            ...
            $.ajax({
                url: "{{ route('salud.indicador.pdrc.actualizar') }}",
                data: {
                    "anio": $('#anio').val(),
