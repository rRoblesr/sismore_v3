...
@section('content')
    ...
    <div class="container mt-4">
        <div class="card card-indicador">
            <div class="header">
                <i class="fas fa-shield-alt"></i> SI 01-01
            </div>
            <div class="progress-circle">
                <canvas id="progressChart" width="120" height="120"></canvas>
                <span id="progressText">71%</span>
            </div>
            <p class="mt-2 text-muted">Actualizado: 02/04/2024</p>
            <div class="status">✔ CUMPLE</div>
            <div class="row mt-3">
                <div class="col-6 text-primary font-weight-bold">
                    <i class="fas fa-arrow-down"></i> Numerador <br> 100
                </div>
                <div class="col-6 text-success font-weight-bold">
                    <i class="fas fa-arrow-up"></i> Denominador <br> 100
                </div>
            </div>
            <p class="mt-3 text-muted">
                Número de gobiernos locales que registraron oportunamente las actas de homologación en el sistema de padrón
                nominal.
            </p>
    ...
    <div class="row">
        @foreach ($indicadores as $indice => $enlace)
            <div class="col-md-4 mb-4">
                <div class="card shadow-sm">
                    <div class="card-body">
                        <h5 class="card-title">Indicador Nº{{ $indice + 1 }}</h5>
                        <p class="card-text">Accede al indicador {{ $indice + 1 }} para ver más detalles.</p>
                        <a href="{{ $enlace }}" target="_blank" class="btn btn-primary btn-block">
                            Ver Indicador
                        </a>
                    </div>
                </div>
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            var progress = 71; // Porcentaje de avance
            var chart = new Chart(ctx, {
                type: "doughnut",
                data: {
                    datasets: [{
                        data: [progress, 100 - progress],
                        backgroundColor: ["#fdd835", "#e0e0e0"],
                        borderWidth: 0
                    }]
                },
                options: {
