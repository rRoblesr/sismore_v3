@extends('layouts.main', ['titlePage' => 'IMPORTAR DATOS - PADRONES'])
@section('css')
    <!-- Table datatable css -->
                    ...
                    <div class="card-header border-success-0 bg-transparent pb-0">
                        <div class="card-widgets">
                            ...
                            <button type="button" class="btn btn-success btn-xs waves-effect waves-light"
                                data-toggle="modal" data-target=".bs-example-modal-lg1" data-backdrop="static"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="myLargeModalLabel">Importar Padronnnn</h5>
                            ...
                            <div class="col-sm-12">
                                <form class="cmxform form-horizontal tasi-form upload_file">
                                    ...
                                    <div class="form-group">
                                        <div class="">
                                            <label class="col-form-label">Fuente de datosss</label>
                                            <div class="">
                                    ...
                                    <div class="form-group row ">
                                        <div class="col-lg-12 text-center">
                                            <button class="btn btn-primary waves-effect waves-light" type="submit"><i
                                                    class="ion ion-md-cloud-upload"></i> Guardarrr</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table_principal = $('#datatable').DataTable({
                ...
                ajax: "{{ route('salud.padron.importar.historial') }}",
                type: "POST",
            });
        });
        ...
        function upload(e) {
            ...
            $.ajax({
                ...
                type: "POST",
                url: "{{ route('salud.padron.importar.cargar') }}",
                dataType: "json",
                contentType: false,
                processData: false,
                cache: false,
