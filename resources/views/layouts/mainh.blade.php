...
<head>
    ...
    {{-- toastr css --}}
    <link rel="stylesheet" href="{{ asset('/') }}public/assets/libs/toastr/toastr.min.css" type='text/css'>
                        ...
                        <ul class="list-unstyled topnav-menu float-right mb-0">
                            ...
                            <li class="dropdown notification-list">
                                ...
                                <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                                    ...
                                    {{--  --}}
                                    <a href="{{ route('usuario.layouts.vertical', auth()->user()->id) }}"
                                        class="dropdown-item notify-item">
                                        <i class="mdi mdi-page-layout-sidebar-left noti-icon"></i>
                                        <span>Vertical</span>
                                    </a>
                                ...
                                <form class="app-search" style="max-width: 600px;">
                                    <div class="app-search-box">
                                        <span style="color:white; font-size: 25px;"><strong>S I S M O R
                                                E</strong></span><br>
                                        <span style="color:white; font-size: 12px;"><strong>SISTEMA DE MONITOREO
                                                REGIONALxxx</strong></span>
                                    </div>
                                </form>
                            </li>
