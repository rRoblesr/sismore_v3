    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table_principal = $('#datatable').DataTable({
                ...
                ajax: "{{ route('imporpoblacionpn.listar.importados') }}",
                type: "POST",
            });
        });
        ...
        function upload(e) {
            ...
            $.ajax({
                ...
                type: "POST",
                url: "{{ route('imporpoblacionpn.guardar') }}",
                dataType: "json",
                contentType: false,
                processData: false,
                cache: false,
        ...
        function geteliminar(id) {
            bootbox.confirm("¿Seguro desea eliminar esta importación?", function(result) {
                if (result === true) {
                    $.ajax({
                        url: "{{ route('imporpoblacionpn.eliminar', '') }}/" + id,
                        type: "GET",
                        dataType: "JSON",
        ...
        function monitor(id) {
            $('#siagie-matricula').DataTable({
                    ...
                    "ajax": {
                        ...
                        "url": "{{ route('imporpoblacionpn.listarimportados') }}",
                        "data": {
                            "importacion_id": id
                        },
                        "type": "POST",
                    ...
                    "columns": [{
                            data: 'anio',
                            name: 'par_poblacion_padron_nominal.anio'
                        },
                        {
                            data: 'mes_codigo',
                            name: 'mm.codigo'
                        ...
                        {
                            data: 'seguro',
                            name: 'par_poblacion_padron_nominal.seguro'
                        },
                        {
                            data: 'cnv',
                            name: 'par_poblacion_padron_nominal.cnv'
                        },
                        {
                            data: '0a',
                            name: 'par_poblacion_padron_nominal.0a'
                        },
                        {
                            data: '1a',
                            name: 'par_poblacion_padron_nominal.1a'
                        },
                        {
                            data: '2a',
                            name: 'par_poblacion_padron_nominal.2a'
                        },
                        {
                            data: '3a',
                            name: 'par_poblacion_padron_nominal.3a'
                        },
                        {
                            data: '4a',
                            name: 'par_poblacion_padron_nominal.4a'
                        },
                        {
                            data: '5a',
                            name: 'par_poblacion_padron_nominal.5a'
                        },
                        {
                            data: '28dias',
                            name: 'par_poblacion_padron_nominal.28dias'
                        },
                        {
                            data: '0_5meses',
                            name: 'par_poblacion_padron_nominal.0_5meses'
                        },
                        {
                            data: '6_11meses',
                            name: 'par_poblacion_padron_nominal.6_11meses'
                        },
                    ],
                }
            );
            $('#modal-siagie-matricula').modal('show');
            $('#modal-siagie-matricula .modal-title').text('Importacion');
        }
    </script>
