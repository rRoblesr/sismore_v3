@extends('layouts.main', ['activePage' => 'usuarios', 'titlePage' => 'Padron de Indicadores'])
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="">
                                            <select class="form-control" name="fugel" id="fugel"
                                                onchange="cargarnivel();cargarlistado();">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input id="nivelmodalidad" name="nivelmodalidad" class="form-control"
                                            value="" readonly>
                                        <span class="help-block"></span>
                                    </div>
    ...
    <script>
        ...
        function cargarlistado() {
            table_principal = $('#tbprincipal').DataTable({
                ...
                ajax: {
                    "url": "{{ route('indicador.ajax.listar') }}",
                    "type": "GET",
                    "data": {
                        /* 'ugel': $('#fugel').val(),
                        'nivel': $('#fnivel').val(),
        ...
        function cargarnivel() {
            $.ajax({
                url: "{{ route('padroneib.nivelmodalidad.cargar') }}",
                data: {
                    'ugel': $('#fugel').val(),
                    'importacion': '{{ $imp->id }}',
                },
