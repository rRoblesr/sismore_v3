                ...
                <div class="col-lg-12 col-md-12">
                    <div class="card">
                        <div class="card-header bg-success-0">
                            ...
                            <h3 class="card-title text-white">Porcentaje De Docentes Titulados En Educación Inicial</h3>
                        </div>
                        <div class="card-body pb-0">
                            <div class="form-group row align-items-center vh-5">
                                <div class="col-lg-5 col-md-5 col-sm-5">
                                    <h5 class="page-title font-12" id="lbl-actualizado">{{ $actualizado }}</h5>
                                </div>
                    ...
                    <div class="card card-border border border-plomo-0">
                        ...
                        <div class="card-body p-0">
                            <figure class="highcharts-figure m-0">
                                <div id="dianal0" style="height: 20rem"></div>
                            </figure>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="card card-border border border-plomo-0">
                        ...
                        <div class="card-body p-0">
                            ...
                            <figure class="highcharts-figure m-0">
                                <div id="dianal1" style="height: 20rem"></div>
                            </figure>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="card card-border border border-plomo-0">
                        ...
                        <div class="card-body p-0">
                            {{-- <div id="container" ></div> --}}
                            <figure class="highcharts-figure m-0">
                                <div id="dianal2" style="height: 20rem"></div>
                            </figure>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="card card-border border border-plomo-0">
                        ...
                        <div class="card-body p-0">
                            {{-- <div id="container" ></div> --}}
                            <figure class="highcharts-figure m-0">
                                <div id="dianal3" style="height: 20rem"></div>
                            </figure>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="card card-border border border-plomo-0">
                        <div class="card-header border-success-0 bg-transparent pb-0">
                            ...
                            <h3 class="card-title">Docente con Título en Educación Inicial, Según Instituciones Educativas
                            </h3>
                        </div>
                        <div class="card-body">
                            <div class="row">
...
@section('js')
    <script type="text/javascript">
        ...
        function cargarCards() {
            $.ajax({
                url: "{{ route('panelcontrol.educacion.indicador.nuevos.06.head') }}",
                data: {
                    "anio": $('#anio').val(),
                ...
                success: function(data) {
                    ...
                    if (data.actualizado) {
                        $('#lbl-actualizado').text(data.actualizado);
                    }
                },
            ...
            panelGraficas('dianal0');
            panelGraficas('dianal1');
            panelGraficas('dianal2');
            panelGraficas('dianal3');
        ...
        function panelGraficas(div) {
            $.ajax({
                url: "{{ route('panelcontrol.educacion.indicador.nuevos.06.tabla') }}",
                data: {
                    'div': div,
                    "anio": $('#anio').val(),
                    "provincia": $('#provincia').val(),
                ...
                success: function(data) {
                    if (div == "dianal0") {
                        gAnidadaColumn(div,
                            ...
                            data.info.series,
                            '',
                            'Porcentaje de Docentes Titulados en Educación Inicial',
                            data.info.maxbar
                        );
                    } else if (div == "dianal1") {
                        gPie(div, data.puntos, '',
                            'Docentes con Título Pedagógico en Educación Inicial, según Sexo', '');
                    } else if (div == "dianal2") {
                        gPie(div, data.puntos, '',
                            'Docentes con Título Pedagógico en Educación Inicial, según Condición Laboral',
                            '');
                    } else if (div == "dianal3") {
                        gPie(div, data.puntos, '',
                            'Docentes con Título Pedagógico en Educación Inicial, según Ámbito Geográfico',
                            '');
                    } else if (div == "ctabla1") {
