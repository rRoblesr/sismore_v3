        ...
        <tfoot>
            <tr class="table-success-0 text-white text-center">
                ...
                <th style="text-align: center">
                    {{ number_format($foot->d01 + $foot->d02 + $foot->d03 + $foot->d04, 0) }}</th>
                <td style="text-align: center">{!! avance($foot->total > 0 ? (100 * ($foot->d01 + $foot->d02 + $foot->d03 + $foot->d04)) / $foot->total : 0, 1) !!}</td>
