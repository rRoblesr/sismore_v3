        ...
        <tbody>
            @foreach ($base as $key => $item)
                <tr class="text-center">
                    ...
                    <td class="text-center table-warning">{{ number_format($item->c2024, 0) }}</td>
                    <td class="text-center">{{ number_format($item->c2024h, 0) }}</td>
                    <td class="text-center">{{ number_format($item->c2024m, 0) }}</td>
                    <td class="text-center">{{ number_format($item->c2021, 0) }}</td>
                    <td class="text-center">{{ number_format($item->c2022, 0) }}</td>
                    <td class="text-center">{{ number_format($item->c2023, 0) }}</td>
                    <td class="text-center table-warning">{{ number_format($item->c2024, 0) }}</td>
                    <td class="text-center">{{ number_format($item->c2025, 0) }}</td>
                    <td class="text-center">{{ number_format($item->c2026, 0) }}</td>
                    <td class="text-center">{{ number_format($item->c2027, 0) }}</td>
                    <td class="text-center">{{ number_format($item->c2028, 0) }}</td>
                    <td class="text-center">{{ number_format($item->c2029, 0) }}</td>
                    <td class="text-center">{{ number_format($item->c2030, 0) }}</td>
                </tr>
            @endforeach
        </tbody>
        <tfoot>
