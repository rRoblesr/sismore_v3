        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-header bg-success-0">
                    ...
                    <h3 class="card-title text-white font-14">SEGUIMIENTO DEL GASTO</h3>
                </div>
                <div class="card-body pb-0">
                    <div class="form-group row align-items-center vh-5">
                        <div class="col-lg-3 col-md-3 col-sm-4">
                            <h4 class="page-title font-12 m-0">Fuente: SIAF-WEB <br><span
                                    id="lbl_actualizado">{{ $actualizado }}</span></h4>
                        </div>
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2">
                            <div class="custom-select-container">
                                ...
                                <select id="rubro" name="rubro" class="form-control font-11">
                                    <option value="0">TODOS</option>
                                </select>
                            </div>
                        </div>
                ...
                <div class="card-body p-0">
                    <div class="col-md-12">
                        ...
                        <div class="row text-center">
                            ...
                            <div class="col-sm-6">
                                <small class="text-muted">RECAUDADO <span id="anal1_anio_dev"></span></small>
    ...
    <script type="text/javascript">
                    ...
                    switch (div) {
                        ...
                        case 'anal2':
                            gAnidadaColumn2(
                                ...
                                data.info.series, {
                                    subtitle: 'Avance de la Recaudación del Ingreso Presupuestal por Rubro de Financiamiento ',
                                    primaryAxis: {
                                        title: '',
                                        unit: '',
                                        decimals: 0
        ...
        function cargarModalDetalle2(codes, nombre) {
            $.ajax({
                url: "{{ route('presupuesto.gastos.seguimiento.tabla0201', ['anio' => ':anio', 'codes' => ':codes', 'ue' => ':ue', 'ff' => ':ff', 'rubro' => ':rubro']) }}"
                    ...
                    .replace(':ue', $('#ue').val())
                    .replace(':ff', $('#ff').val())
                    .replace(':rubro', $('#rubro').val()),
                type: 'GET',
                success: function(data) {
                    $('#modalDetalleLabel').html(nombre);
                    $('#ctabla0101').html(data.excel);
        ...
        function cargarRubro() {
            $.ajax({
                ...
                success: function(data) {
                    $('#rubro').empty();
                    if (Object.keys(data).length > 1)
                        $('#rubro').append('<option value="0">TODOS</option>');
                    $.each(data, function(index, value) {
                        $('#rubro').append(`<option value='${index}'>${value}</option>`);
                    });
                    cargarCards();
                },
                error: function(jqXHR, textStatus, errorThrown) {
        ...
        function actualizarActualizado() {
            $.ajax({
                ...
                success: function(data) {
                    if (data.actualizado) {
                        $('#lbl_actualizado').text(data.actualizado);
                    }
                },
                error: function(jqXHR, textStatus, errorThrown) {
                    console.log(jqXHR);
        ...
        function gDonut1(div, data, options = {}) {
            ...
            Highcharts.chart(div, {
                ...
                title: {
                    text: 'Avance de la Recaudación del Ingreso Presupuestal',
                    style: {
