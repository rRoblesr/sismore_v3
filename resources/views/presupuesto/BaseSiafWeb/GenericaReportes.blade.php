...
@section('content')
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-header bg-success-0">
                    ...
                    <h3 class="card-title text-white font-14">EJECUCIÓN PRESUPUESTAL POR GENÉRICA Y SUB GENÉRICA DETALLE
                    </h3>
                </div>
                <div class="card-body pb-0">
                    <div class="form-group row align-items-center vh-5">
                        ...
                        <div class="col-lg-3 col-md-32 col-sm-2">
                            <div class="custom-select-container">
                                <label for="ff">Fuente Financiamiento</label>
        ...
        <div class="col-lg-12">
            ...
            <div class="card card-border border border-plomo-0">
                <div class="card-header border-success-0 bg-transparent pb-0 pt-2">
                    ...
                    <h3 class="card-title">
                        Ejecución del Gasto Presupuestal por Generica
                    </h3>
                </div>
                <div class="card-body">
                    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <div class="card card-border border border-plomo-0">
                <div class="card-header border-success-0 bg-transparent pb-0 pt-2">
                    ...
                    <h3 class="card-title">
                        Ejecución del Gasto Presupuestal por Sub Genérica
                    </h3>
                </div>
                <div class="card-body">
                    <div class="row">
    ...
    {{-- create un modal para mostar los detalles de la categoria presupuestal por anio --}}
...
@section('js')
    <script type="text/javascript">
        ...
        function panelGraficas(div) {
            $.ajax({
                url: "{{ route('presupuesto.rubro2.reportes.reporte') }}",
                data: {
                    'div': div,
                    "anio": $('#anio').val(),
                    "ue": $('#ue').val(),
                ...
                success: function(data) {
                    switch (div) {
                        case 'anal1':
                            //data_ejemplo = ["pim" => 745246510, "devengado" => 668700682.9, "avance" => 89.7];
                            gDonut1(div, data);
                        ...
                        case 'anal2':
                            gAnidadaColumn2(
                                ...
                                data.info.series, {
                                    subtitle: 'Ejecución del Gasto Presupuestal por Categoría Presupuestal',
                                    primaryAxis: {
                                        title: '',
                                        unit: '',
                                        decimals: 0
        ...
        function cargarPresupuesto() {
            $.ajax({
                url: "{{ route('presupuesto.saifweb.detalle.select.cp.2', ['anio' => ':anio', 'ue' => ':ue']) }}"
                    .replace(':anio', $('#anio').val())
                    .replace(':ue', $('#ue').val()),
                type: 'GET',
                success: function(data) {
                    $('#cp').empty();
                    if (Object.keys(data).length > 1)
                        $('#cp').append('<option value="todos">TODOS</option>');
                    $.each(data, function(index, value) {
        ...
        function cargarFuenteFinanciamiento() {
            $.ajax({
                url: "{{ route('presupuesto.saifweb.detalle.select.ff.2', ['anio' => ':anio', 'ue' => ':ue', 'cp' => ':cp']) }}"
                    .replace(':anio', $('#anio').val())
                    .replace(':ue', $('#ue').val())
                    .replace(':cp', encodeURIComponent($('#cp').val())),
                type: 'GET',
                success: function(data) {
                    $('#ff').empty();
                    if (Object.keys(data).length > 1)
        ...
        function descargarExcel(div) {
            window.open(
                "{{ route('presupuesto.generica.reportes.download.excel', ['div' => ':div', 'anio' => ':anio', 'ue' => ':ue', 'cp' => ':cp', 'ff' => ':ff', 'g' => ':g', 'sg' => ':sg']) }}"
                .replace(':div', div)
                .replace(':anio', $('#anio').val())
                .replace(':ue', $('#ue').val())
                .replace(':cp', encodeURIComponent($('#cp').val()))
        ...
        function gDonut1(div, data, options = {}) {
            ...
            Highcharts.chart(div, {
                ...
                title: {
                    text: 'Avance de la Ejecución del Gasto Presupuestal',
                    style: {
