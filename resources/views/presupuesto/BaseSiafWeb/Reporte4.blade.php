@extends('layouts.main', ['activePage' => 'usuarios', 'titlePage' => 'Función'])
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header bg-success-0 pt-2">
                        ...
                        <h3 class="card-title text-white">Ejecución de Gastos, según Función</h3>
                    </div>
            ...
            <div class="col-xl-12 principal">
                <div class="card card-border">
                    <div class="card-header border-success-0 bg-transparent p-0">
                        ...
                        <h3 class="card-title">Ejecución de Gastos, según Función</h3> --}}
                    </div>
...
@section('js')
    ...
    <script>
        ...
        function graficar(id, nombre) {
            ...
            $.ajax({
                url: "{{ route('basesiafweb.rpt4.gra.1') }}",
                data: {
                    'anio': $('#ganio').val(),
                    'articulo': $('#garticulo').val(),
                    'ue': $('#gue').val(),
        ...
        function descargar() {
            $.ajax({
                url: "{{ url('/') }}/SiafGastos/reportes4/Exportar/excel/null/null/null",
                type: "GET",
                success: function(data) {
                    window.open("{{ url('/') }}/SiafGastos/reportes4/Exportar/excel/" +
