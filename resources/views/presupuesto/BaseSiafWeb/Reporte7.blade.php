@extends('layouts.main', ['activePage' => 'usuarios', 'titlePage' => 'Especifica Detalle'])
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header bg-success-0 pt-2">
                        ...
                        <h3 class="card-title text-white">Ejecución de Gastos, según Especifica Detalle</h3>
                    </div>
                            ...
                            <div class="form">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-2 col-md-3 col-sm-12">
                                        <div class="custom-select-container">
                                            <label for="garticulo">PRODUCTO/PROYECTO</label>
                                    ...
                                    <div class="col-lg-2 col-md-4 col-sm-12">
                                        <div class="custom-select-container">
                                            <label for="gue">UNIDAD EJECUTORA</label>
                                    ...
                                    <div class="col-lg-2 col-md-3 col-sm-12">
                                    <div class="custom-select-container">
                                        <label for="gff">FUENTE</label>
                                        <select class="form-control font-11" name="gff" id="gff"
                                            onchange="cargarcuadros2();">
                                            <option value="0">TODOS</option>
                                            @foreach ($ff as $item)
                                    ...
                                    <div class="col-lg-2 col-md-2 col-sm-12">
                                        <div class="custom-select-container">
                                            <label for="ggg">GENÉRICAS</label>
                                            <select class="form-control font-11" name="ggg" id="ggg"
                                                onchange="cargarcuadros2();">
                                                <option value="0">TODOS</option>
                                                @foreach ($gg as $item)
                                    ...
                                    <div class="col-lg-2 col-md-2 col-sm-12">
                                        <div class="custom-select-container">
                                            <label for="gpartidas">PARTIDAS</label>
                                            <select class="form-control font-11" name="gpartidas" id="gpartidas"
                                                onchange="cargarcuadros2();">
                                                <option value="0">TODAS</option>
                                                <option value="1">RESTRINGIDAS</option>
                                                <option value="2">NO RESTRINGIDAS</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="col-xl-12">
                <div class="card card-border">
                    <div class="card-header border-success-0 bg-transparent pt-2 pb-0">
                        <h3 class="card-title anal1">GRAFICO</h3>
                    </div>
...
@section('js')
    ...
    <script>
        ...
        function graficar(id, nombre) {
            $.ajax({
                url: "{{ route('basesiafweb.rpt7.gra.1') }}",
                data: {
                    'anio': $('#ganio').val(),
                    'articulo': $('#garticulo').val(),
                    'ue': $('#gue').val(),
