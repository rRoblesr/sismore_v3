...
<div class="content">
    ...
    <div class="row">
        <div class="col-md-12">           
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('ProEmpleo.procesar',$importacion_id)}}" method="post" enctype='multipart/form-data'  class="cmxform form-horizontal tasi-form">                            
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-2">
                                <input type="text" class="form-control" readonly="readonly" value="{{$proEmpleo->mes}} - {{$proEmpleo->anio}}">                                
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-2">
                                <input type="text" class="form-control" readonly="readonly" value="{{$proEmpleo->oferta_hombres}}">                                
                            </div>
                       
                            <label class="col-md-2 col-form-label">Oferta Mujeres</label>
                            <div class="col-md-2">
                                <input type="text" class="form-control" readonly="readonly" value="{{$proEmpleo->oferta_mujeres}}">                           
                            </div>

                            <label class="col-md-2 col-form-label">Demanda</label>
                            <div class="col-md-2">
                                <input type="text" class="form-control" readonly="readonly" value="{{$proEmpleo->demanda}}">                           
                            </div>
                        </div>
        ...
        <div class="col-md-12">
            <div class="card">
                @include('trabajo.ProEmpleo.ListaParcial')         
            </div>
        </div>
