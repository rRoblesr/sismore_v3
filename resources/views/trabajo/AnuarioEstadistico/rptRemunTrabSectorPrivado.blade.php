@extends('layouts.main',['activePage'=>'importacion','titlePage'=>'PROMEDIO DE REMUNERACIÓN ( NUEVOS SOLES S/ ) DE TRABAJADORES EN EL SECTOR PRIVADO POR MES'])
...
<div class="row">
    <div class="col-md-12 col-xl-12">
        <div class="alert alert-info">                                                          
            <div id="Grafico_Promedio_Remuneracion_porAnio">       
...
<div class="row">
    <div class="col-md-12 col-xl-12">
        <div class="alert alert-info">  
            ...
            <div id="Grafico_ranking_promedio_remuneracion_regiones">       
                {{-- se carga con el scrip lineas abajo --}}
            </div>                     
        </div>                 
    </div>
...
@section('js')
 ...
 <script type="text/javascript">
    ...
    $(document).ready(function() {
        Grafico_Promedio_Remuneracion_porAnio();
        Grafico_ranking_promedio_remuneracion_regiones();
    });
    ...
    function Grafico_ranking_promedio_remuneracion_regiones() {
     ...
     $('#tabla').DataTable({
         "ajax": "{{route('AnuarioEstadistico.rptAnuarioEstadistico_DataTable','19')}}",
         "columns":[             
