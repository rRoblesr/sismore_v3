                                        ...
                                        <div class="card-header border-success-0 bg-transparent pb-0 pt-2"
                                            ...
                                            <div class="card-widgets">
                                                ...
                                                <a href="javascript:void(0)" class="waves-effect waves-light"
                                                    data-toggle="modal" data-target="#myModal-container1"><i
                                    ...
                                    <div class="card card-border border border-plomo-0">
                                        <div class="card-header border-success-0 bg-transparent pb-0 pt-2"
                                            ...
                                            <div class="card-widgets">
                                                ...
                                                <a href="javascript:void(0)" class="waves-effect waves-light"
                                                    data-toggle="modal" data-target="#myModal-container2"><i
                                                        class="mdi mdi-information text-orange-0" title="INFORMACIÓN"></i></a>
                                            </div>
                                            <h3
                                                class="card-title text-black text-center text-capitalize font-weight-normal font-11">
                                    ...
                                    <div class="card card-border border border-plomo-0">
                                        <div class="card-header border-success-0 bg-transparent pb-0 pt-2"
                                            ...
                                            <div class="card-widgets">
                                                ...
                                                <a href="javascript:void(0)" class="waves-effect waves-light"
                                                    data-toggle="modal" data-target="#myModal-container3"><i
                                                        class="mdi mdi-information text-orange-0" title="INFORMACIÓN"></i></a>
                                            </div>
                                            <h3
                                                class="card-title text-black text-center text-capitalize font-weight-normal font-11">
                                    ...
                                    <div class="card card-border border border-plomo-0">
                                        <div class="card-header border-success-0 bg-transparent pb-0 pt-2"
                                            ...
                                            <div class="card-widgets">
                                                ...
                                                <a href="javascript:void(0)" class="waves-effect waves-light"
                                                    data-toggle="modal" data-target="#myModal-dtanal3"><i
                                                        class="mdi mdi-information text-orange-0" title="INFORMACIÓN"></i></a>
                                            </div>
                                            <h3
                                                class="card-title text-black text-center text-capitalize font-weight-normal font-11">
                                    ...
                                    <div class="card card-border border border-plomo-0">
                                        <div class="card-header border-success-0 bg-transparent pb-0 pt-2"
                                            ...
                                            <div class="card-widgets">
                                                ...
                                                <a href="javascript:void(0)" class="waves-effect waves-light"
                                                    data-toggle="modal" data-target="#myModal-dtanal2"><i
                                                        class="mdi mdi-information text-orange-0" title="INFORMACIÓN"></i></a>
                                            </div>
                                            <h3
                                                class="card-title text-black text-center text-capitalize font-weight-normal font-11">
                                    ...
                                    <div class="card card-border border border-plomo-0">
                                        <div class="card-header border-success-0 bg-transparent pb-0 pt-2"
                                            ...
                                            <div class="card-widgets">
                                                ...
                                                <a href="javascript:void(0)" class="waves-effect waves-light"
                                                    data-toggle="modal" data-target="#myModal-anal3"><i
                                                        class="mdi mdi-information text-orange-0" title="INFORMACIÓN"></i></a>
                                            </div>
                                            <h3
                                                class="card-title text-black text-center text-capitalize font-weight-normal font-11">
                                    ...
                                    <div class="card card-border border border-plomo-0">
                                        <div class="card-header border-success-0 bg-transparent pb-0 pt-2"
                                            ...
                                            <div class="card-widgets">
                                                ...
                                                <a href="javascript:void(0)" class="waves-effect waves-light"
                                                    data-toggle="modal" data-target="#myModal-anal4"><i
                                                        class="mdi mdi-information text-orange-0" title="INFORMACIÓN"></i></a>
                                            </div>
                                            <h3
                                                class="card-title text-black text-center text-capitalize font-weight-normal font-11">
...
<div id="myModal-container1" class="modal fade font-10" tabindex="-1" role="dialog"
...
<div id="myModal-container2" class="modal fade font-10" tabindex="-1" role="dialog"
    aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
...
<div id="myModal-container3" class="modal fade font-10" tabindex="-1" role="dialog"
    aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
...
<div id="myModal-anal1" class="modal fade font-10" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
...
<div id="myModal-anal2" class="modal fade font-10" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
...
<div id="myModal-anal4" class="modal fade font-10" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
