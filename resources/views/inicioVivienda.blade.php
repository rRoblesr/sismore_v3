    ...
    <div class="row">
        ...
        <div class="col-md-6 ">
            <p style="text-align: right; color:rgb(147, 141, 141)"> Ultima Actualización: {{ $fechaVersion }}
                <br>Fuente: Ministerio de Vivienda, Construcción y Saneamiento - DATASS
            </p>
        </div>
    </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-12">
                    <select id="indicador" name="indicador" class="form-control" onchange="cargar_datos();">
                        ...
                        <option value=4> 4. Porcentaje de Hogares con Cobertura de Alcantarillado u Otras Formas de
                            Disposición Sanitaria de Excretas </option>
                        <option value=5> 5. Porcentaje de Hogares en Ambito Rural que Consume Agua Segura (Clorada)
                        </option>
                    </select>
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        function Grafico_IndicadorRegional() {
            ...
            $.ajax({
                ...
                url: "{{ url('/') }}/Datass/Grafico_IndicadorRegional/" + $('#indicador').val() + "/" +
                    {{ $importacion_id }},
                type: 'post',
            }).done(function(data) {
        ...
        function Grafico_IndicadorProvincial() {
            ...
            $.ajax({
                ...
                url: "{{ url('/') }}/Datass/Grafico_IndicadorProvincial/" + $('#indicador').val() + "/" +
                    {{ $importacion_id }},
                type: 'post',
            }).done(function(data) {
        ...
        function Grafico_IndicadorProvincial_masDistrital() {
            ...
            $.ajax({
                ...
                url: "{{ url('/') }}/Datass/Grafico_IndicadorProvincial_masDistrital/" + $('#indicador')
                    .val() + "/" + {{ $importacion_id }},
                type: 'post',
            }).done(function(data) {
