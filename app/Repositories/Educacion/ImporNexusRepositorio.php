...
class ImporNexusRepositorio
{
    ...
    {
        return DB::table('edu_impor_nexus as ix')
            ->select(
                'ix.ugel',
                'ix.provincia',
                'ix.distrito',
                ...
                'ix.cod_mod',
                'ix.cod_local',
                'ix.institucion_educativa',
                'ix.cod_plaza',
                'ix.tipo_trabajador',
                'ix.subtipo_trabajador',
                'ix.cargo',
                'ix.situacion_laboral',
                'ix.categoria_remunerativa',
                'ix.escala_remunerativa',
                'ix.jec',
                'ix.jornada_laboral',
                'ix.estado',
                'ix.tipo_registro',
                ...
                'ix.profesion',
                'ix.grado_obtenido',
                'ix.regimen_pensionario',
                'ix.afp',
                'ix.ley',
                'ix.fecha_nombramiento'
            )
