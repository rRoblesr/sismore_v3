...
class ImporNexusRepositorio
{
    public static function Listar_Por_Importacion_id($importacion_id)
    {
        $q = DB::table('edu_impor_nexus as ix')
            ->select(
                DB::raw('null as unidad_ejecutora'),
                DB::raw('ix.ugel as organo_intermedio'),
                DB::raw('ix.provincia as provincia'),
                DB::raw('ix.distrito as distrito'),
                DB::raw('ix.tipo_ie as tipo_ie'),
                DB::raw('ix.gestion as gestion'),
                DB::raw('ix.zona as zona'),
                DB::raw('ix.cod_mod as codmod_ie'),
                DB::raw('ix.cod_local as codigo_local'),
                DB::raw('null as clave8'),
                DB::raw('ix.nivel_educativo as nivel_educativo'),
                DB::raw('ix.institucion_educativa as institucion_educativa'),
                DB::raw('ix.jec as jec'),
                DB::raw('ix.cod_plaza as codigo_plaza'),
                DB::raw('ix.tipo_trabajador as tipo_trabajador'),
                DB::raw('ix.subtipo_trabajador as sub_tipo_trabajador'),
                DB::raw('ix.cargo as cargo'),
                DB::raw('ix.situacion_laboral as situacion_laboral'),
                DB::raw('null as motivo_vacante'),
                DB::raw('ix.categoria_remunerativa as categoria_remunerativa'),
                DB::raw('ix.escala_remunerativa as descripcion_escala'),
                DB::raw('ix.jornada_laboral as jornada_laboral'),
                DB::raw('ix.estado as estado'),
                DB::raw('null as fecha_inicio'),
                DB::raw('null as fecha_termino'),
                DB::raw('ix.tipo_registro as tipo_registro'),
                DB::raw('ix.ley as ley'),
                DB::raw('ix.fecha_nombramiento as fecha_ingreso'),
                DB::raw('ix.num_documento as documento_identidad'),
                DB::raw('null as codigo_modular'),
                DB::raw('ix.apellido_paterno as apellido_paterno'),
                DB::raw('ix.apellido_materno as apellido_materno'),
                DB::raw('ix.nombres as nombres'),
                DB::raw('ix.fecha_nacimiento as fecha_nacimiento'),
                DB::raw('ix.sexo as sexo'),
                DB::raw('ix.regimen_pensionario as regimen_pensionario'),
                DB::raw('null as fecha_afiliacion_rp'),
                DB::raw('null as codigo_essalud'),
                DB::raw('ix.afp as afp'),
                DB::raw('null as codigo_afp'),
                DB::raw('null as fecha_afiliacion_afp'),
                DB::raw('null as fecha_devengue_afp'),
                DB::raw('null as mencion'),
                DB::raw('null as centro_estudios'),
                DB::raw('ix.tipo_estudios as tipo_estudios'),
                DB::raw('null as estado_estudios'),
                DB::raw('ix.profesion as especialidad_profesional'),
                DB::raw('ix.grado_obtenido as grado'),
                DB::raw('null as celular'),
                DB::raw('null as email'),
                DB::raw('null as especialidad'),
                DB::raw('null as fecha_resolucion'),
                DB::raw('null as numero_resolucion'),
                DB::raw('null as desc_superior'),
                DB::raw('null as numero_contrato_cas'),
                DB::raw('null as numero_adenda_cas'),
                DB::raw('null as preventiva'),
                DB::raw('null as referencia_preventiva')
            )
            ->where('ix.importacion_id', $importacion_id);
