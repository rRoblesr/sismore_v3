...
class MenuRepositorio
{
  ...
  */
  ...
  public static function Listar_Nivel01_porPerfil_Sistema($perfil_id, $sistema_id)
  {
    $data = Menu::select(
      'adm_menu.id',
      'adm_menu.dependencia',
      ...
      ->join('adm_menu_perfil as menPer', 'adm_menu.id', '=', 'menPer.menu_id')
      ->where("menPer.perfil_id", "=", $perfil_id)
      ->where("adm_menu.sistema_id", "=", $sistema_id)
      ->where("adm_menu.estado", "=", 1)
      ->where("adm_menu.dependencia", "=", null)
      ->orderBy('adm_menu.dependencia', 'asc')
  ...
  public static function Listar_Nivel02_porPerfil_Sistema($perfil_id, $sistema_id)
  {
    $data = Menu::from('adm_menu as sm')->select(
      'sm.id',
      'sm.dependencia',
  ...
  public static function Listar_Nivel03_porPerfil_Sistema($perfil_id, $sistema_id)
  {
    $data = Menu::from('adm_menu as ssm')->select(
      'ssm.id',
      'ssm.dependencia',
