...
class SuperiorTecnologicoController extends Controller
{
    ...
    {
        $valor1 = ImporCensoMatriculaRepositorio::_6APrincipalHead($rq->anio, $rq->provincia, $rq->distrito, $rq->ugel,  $rq->area, $rq->gestion, 1);
        $valor2 = ImporCensoMatriculaRepositorio::_6APrincipalHead($rq->anio, $rq->provincia, $rq->distrito, $rq->ugel,  $rq->area, $rq->gestion, 2);
        $valor3 = ImporCensoMatriculaRepositorio::_6APrincipalHead($rq->anio, $rq->provincia, $rq->distrito, $rq->ugel,  $rq->area, $rq->gestion, 3);
        $valor4 = ImporCensoMatriculaRepositorio::_6APrincipalHead($rq->anio, $rq->provincia, $rq->distrito, $rq->ugel,  $rq->area, $rq->gestion, 4);
        ...
        switch ($rq->div) {
            case 'anal1':
                ...
                foreach ($imps as $key => $value) {
                    ...
                    if ($key == 0) {
                        $inicio = ImporCensoMatriculaRepositorio::_6ATotalEstudianteAnio($value->anio - 1, $rq->provincia, $rq->distrito, $rq->ugel,  $rq->area, $rq->gestion);
                        if ($inicio) {
                            $banio = $inicio->anio;
                ...
                $totales = ImporCensoMatriculaRepositorio::_6AReportes($rq->anio, $rq->provincia, $rq->distrito,  $rq->ugel, $rq->area, $rq->gestion, 1);
            ...
            case 'anal2':
                ...
                $totales = ImporCensoMatriculaRepositorio::_6AReportes($rq->anio, $rq->provincia, $rq->distrito,  $rq->ugel, $rq->area, $rq->gestion, 2);
            ...
            case 'anal3':
                ...
                $info = ImporCensoMatriculaRepositorio::_6AReportes($rq->anio, $rq->provincia, $rq->distrito, $rq->ugel, $rq->area, $rq->gestion, 3);
                $categoria = [];
                $hh = [];
                $mm = [];
            ...
            case 'anal4':
                ...
                $info = ImporCensoMatriculaRepositorio::_6AReportes($rq->anio, $rq->provincia, $rq->distrito,  $rq->ugel, $rq->area, $rq->gestion, 4);
                $categoria = [];
                $hh = [];
                $mm = [];
                foreach ($info as $key => $value) {
            ...
            case 'tabla1':
                ...
                $base = ImporCensoMatriculaRepositorio::_6AReportes($rq->anio, $rq->provincia, $rq->distrito, $rq->ugel,  $rq->area, $rq->gestion, 5);
                ...
                $docentes = ImporCensoMatriculaRepositorio::_6ATotalDocentesAnioModular($rq->anio, $rq->provincia, $rq->distrito, $rq->ugel,  $rq->area, $rq->gestion, 1);
                $meta = ImporCensoMatriculaRepositorio::_6ATotalEstudiantesAnioMeta($rq->anio - 1, $rq->provincia, $rq->distrito, $rq->ugel,  $rq->area, $rq->gestion);
