...
class SuperiorArtisticoExport implements FromView, ShouldAutoSize
{
    public $ano;
    public $ugel;
    public $area;
    ...
    {
        $base = ImporCensoMatriculaRepositorio::_9AReportes($this->ano, 0, 0, $this->ugel, $this->area, $this->gestion, 5);
        ...
        $docentes = ImporCensoMatriculaRepositorio::_9ATotalDocentesAnioModular($this->ano, 0, 0, $this->ugel, $this->area, $this->gestion, 1);
        $meta = ImporCensoMatriculaRepositorio::_9ATotalEstudiantesAnioMeta($this->ano - 1, 0, 0, $this->ugel, $this->area, $this->gestion);
        ...
        return view("educacion.SuperiorArtistico.PrincipalTabla1excelExport", compact('base', 'foot'));
    }
}
