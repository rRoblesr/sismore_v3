...
class SuperiorTecnologicoExport implements FromView, ShouldAutoSize
{
    public $ano;
    public $ugel;
    public $area;
    ...
    {
        $base = ImporCensoMatriculaRepositorio::_6AReportes($this->ano, 0, 0, $this->ugel, $this->area, $this->gestion, 5);
        ...
        $docentes = ImporCensoMatriculaRepositorio::_6ATotalDocentesAnioModular($this->ano, 0, 0, $this->ugel, $this->area, $this->gestion, 1);
        $meta = ImporCensoMatriculaRepositorio::_6ATotalEstudiantesAnioMeta($this->ano, 0, 0, $this->ugel, $this->area, $this->gestion);
        ...
        return view("educacion.SuperiorTecnologico.PrincipalTabla1excelExport", compact('base', 'foot'));
    }
}
