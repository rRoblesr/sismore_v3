...
class SiafWebRPT4Export implements FromView, ShouldAutoSize, WithEvents
{
    public $ano;
    public $articulo;
    public $ue;
    ...
    {
        $body = BaseSiafWebRepositorio::listar_funcion_anio_acticulo_ue_categoria($this->ano, $this->articulo, $this->ue);
        ...
        return view("Presupuesto.BaseSiafWeb.Reporte4Tabla1Export", compact('body', 'foot'));
    }
