...
class SiafWebRPT2Export implements FromView, ShouldAutoSize, WithEvents
{
    public $ano;
    public $articulo;
    public $ue;
    ...
    public function __construct($ano, $articulo, $ue, $tc)
    {
        $this->ano = $ano;
    ...
    {
        $body = BaseSiafWebRepositorio::listar_categoria_anio_acticulo_ue_categoria($this->ano, $this->articulo, $this->ue, $this->tc);
        ...
        return view("Presupuesto.BaseSiafWeb.Reporte2Tabla1Export", compact('body', 'foot'));
    }
