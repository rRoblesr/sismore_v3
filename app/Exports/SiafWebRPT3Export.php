...
class SiafWebRPT3Export implements FromView, ShouldAutoSize, WithEvents
{
    public $ano;
    public $articulo;
    public $ue;
    ...
    public function __construct($ano, $articulo, $ue, $ff)
    {
        $this->ano = $ano;
    ...
    {
        $body = BaseSiafWebRepositorio::listar_productoproyecto_anio_acticulo_ue_categoria($this->ano, $this->articulo, $this->ue, $this->ff);
        ...
        return view("Presupuesto.BaseSiafWeb.Reporte3Tabla1Export", compact('body', 'foot'));
    }
