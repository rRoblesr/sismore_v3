...
class SiafWebRPT7Export implements FromView, ShouldAutoSize, WithEvents
{
    public $ano;
    public $articulo;
    public $ue;
    ...
    public function __construct($ano, $articulo, $ue, $ff, $gg, $partidas)
    {
        $this->ano = $ano;
    ...
    {
        $body = BaseSiafWebRepositorio::listar_subgenerica_anio_acticulo_ue_categoria($this->ano, $this->articulo, $this->ue, $this->ff, $this->gg, $this->partidas);
        ...
        return view("Presupuesto.BaseSiafWeb.Reporte7Tabla1Export", compact('body', 'foot'));
    }
